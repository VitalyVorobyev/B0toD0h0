void tmva_reader_gen_lh(){
/////////////////
// TMVA Reader //
/////////////////
  TMVA::Reader* reader = new TMVA::Reader("!Color:!Silent:V");

  TFile *ifile = TFile::Open("/home/vitaly/Belle_analysis/B0toDh0_Belle/Tuples/b2dh_continuum.root");
  TTree *tree = (TTree*)ifile->Get("TEvent");
//  ifile->Close();

  TFile ofile("fil_b2dh_cont_lh.root","RECREATE");
