...
void Purity_2d_fit_etappp_corr(bool data = false){
...
//  if(keysflag) deMin = -0.3;
  ...
  const double DE_MIN = de_min_etappp;
  const double DE_MAX = de_max_etappp;
//  RooConstVar DELO("DELO","DELO",DE_MIN);
  ...
  const double BDTG_MIN = bdtg_cut_etappp;
...
//  RooDataHist* dh = ds0->binnedClone();
  ...
  // mbc pdf //
  /////////////
  RooRealVar c1_mbc0("c1_mbc0","c1_mbc0",m_mbc0_c1_eta20,-0.1,0.); c1_mbc0.setConstant(kTRUE);
  RooRealVar c2_mbc0("c2_mbc0","c2_mbc0",m_mbc0_c2_eta20,0.,1.);   c2_mbc0.setConstant(kTRUE);
  RooRealVar c3_mbc0("c3_mbc0","c3_mbc0",m_mbc0_c3_eta20,0.,10.);  c3_mbc0.setConstant(kTRUE);
  RooRealVar mbc0("mbc0","mbc0",m_mbc0_c0_eta20,5.26,5.30); if(cSIG) mbc0.setConstant(kTRUE);
//  RooFormulaVar _mbc0("_mbc0","_mbc0","abs(@0+@1*@2+@1*@1*@3+@1*@1*@1*@4) > abs(@0+@5*@2+@5*@5*@3+@5*@5*@5*@4) ? (@0+@5*@2+@5*@5*@3+@5*@5*@5*@4) : @0+@1*@2+@1*@1*@3+@1*@1*@1*@4",RooArgList(mbc0,de,c1_mbc0,c2_mbc0,c3_mbc0,DELO));
  ...
  RooRealVar c1_alpha("c1_alpha","c1_alpha",m_alpha_c1_eta20,-2.,0.); c1_alpha.setConstant(kTRUE);
  RooRealVar c2_alpha("c2_alpha","c2_alpha",m_alpha_c2_eta20,10.,100.);c2_alpha.setConstant(kTRUE);
  RooRealVar alpha("alpha","alpha",m_alpha_c0_eta20,0.,0.1); if(cSIG) alpha.setConstant(kTRUE);
  RooFormulaVar _alpha("_alpha","_alpha","abs(@0+@1*@2+@1*@1*@3) > abs(@0+@4*@2+@4*@4*@3) ? (@0+@4*@2+@4*@4*@3) : (@0+@1*@2+@1*@1*@3)",RooArgList(alpha,de,c1_alpha,c2_alpha,DELO));

  RooRealVar c1_width("c1_width","c1_width",m_width_c1_eta20,-2.,0.);  c1_width.setConstant(kTRUE);
  RooRealVar c2_width("c2_width","c2_width",m_width_c2_eta20,10.,100.);c2_width.setConstant(kTRUE);
  RooRealVar width("width","width",m_width_c0_eta20,0.,0.1); if(cSIG) width.setConstant(kTRUE);
  ...
  // de pdf //
  ////////////
  RooRealVar c10("c10","c10",m_c10_eta20,-10.,10.);c10.setConstant(kTRUE);
  RooRealVar c11("c11","c11",m_c11_eta20,-10.,10); c11.setConstant(kTRUE);
  RooRealVar c12("c12","c12",m_c12_eta20,-10.,10); c12.setConstant(kTRUE);
  RooRealVar c20("c20","c20",m_c20_eta20,-10.,10.);c20.setConstant(kTRUE);
  RooRealVar c21("c21","c21",m_c21_eta20,-10.,10); c21.setConstant(kTRUE);
  RooRealVar c22("c22","c22",m_c22_eta20,-10.,10); c22.setConstant(kTRUE);
  ...
  // mbc pdf //
  /////////////
  RooRealVar argpar("argpar","argus shape parameter",m_argpar_eta20,-100.,-1.); argpar.setConstant(kTRUE);
  RooRealVar argedge("argedge","argedge",m_argedge_eta20,5.285,5.292);          argedge.setConstant(kTRUE);
...
//  RooRealVar pow2("pow2","pow2",0.12,0.1,10);
  ...
  RooRealVar edge("edge","edge",5.29,5.28,5.30,"GeV");       edge.setConstant(kTRUE);
  RooRealVar mbctau("mbctau","mbctau",m_mbctau_bbcomb_eta20,-100,0.,"GeV"); mbctau.setConstant(kTRUE);
  RooRealVar pow1("pow1","pow1",m_pow1_bbcomb_eta20,0.1,10);                pow1.setConstant(kTRUE);
  RooRealVar pow2("pow2","pow2",m_pow2_bbcomb_eta20,0.1,10);                pow2.setConstant(kTRUE);
  ...
  // de pdf //
  ////////////
  RooRealVar c3("c3","c3",m_c0_bb_eta20,-100000.,10.); c3.setConstant(kTRUE);
  RooRealVar c31("c31","c31",m_c1_bb_eta20,-10.,10.); c31.setConstant(kTRUE);
  RooRealVar c32("c32","c32",m_c2_bb_eta20,-10.,10.); c32.setConstant(kTRUE);
  RooFormulaVar _c3("_c3","@0+@1*@3+@2*@3*@3",RooArgSet(c3,c31,c32,mbc));
  RooRealVar c30("c30","c30",-3.333,-100000.,10.); c30.setConstant(kTRUE);
  RooExponential pdf_de_bb_comb("pdf_de_bb_comb","pdf_de_bb_comb",de,c30);
