...
void draw_egamma_omega(void){
  TChain* sig_tree = new TChain("TEvent","TEvent");
  sig_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_sigmcOMEGA_s6_m3_h0m20.root");
  TChain* bkg_tree = new TChain("TEvent","TEvent");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_charm_0_10_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_charm_1_11_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_charm_2_12_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_charm_3_13_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_charm_4_14_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_charm_5_15_m3_h0m20.root");

  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_charged_0_10_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_charged_1_11_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_charged_2_12_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_charged_3_13_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_charged_4_14_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_charged_5_15_m3_h0m20.root");

  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_mixed_0_10_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_mixed_1_11_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_mixed_2_12_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_mixed_3_13_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_mixed_4_14_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_mixed_5_15_m3_h0m20.root");

  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_uds_0_10_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_uds_1_11_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_uds_2_12_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_uds_3_13_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_uds_4_14_m3_h0m20.root");
  bkg_tree->Add("/home/vitaly/B0toDh0/Tuples/Fil_b2dh_uds_5_15_m3_h0m20.root");
  ...
  TH1D* h_ppi0_sig = new TH1D("h_ppi0_sig","h_ppi0_sig",60,0.,3.);
  TH1D* h_ppi1_sig = new TH1D("h_ppi1_sig","h_ppi1_sig",60,0.,3.);
  TH1D* h_ppi2_sig = new TH1D("h_ppi2_sig","h_ppi2_sig",60,0.,3.);
  TH1D* h_hel_sig  = new TH1D("h_hel_sig","h_hel_sig",60,0.,1.);
  TH1D* h_helpi0_sig  = new TH1D("h_helpi0_sig","h_helpi0_sig",60,0.,1.);

  TH1D* h_ptpi1_sig = new TH1D("h_ptpi1_sig","h_ptpi1_sig",60,0.,3.);
  TH1D* h_ptpi2_sig = new TH1D("h_ptpi2_sig","h_ptpi2_sig",60,0.,3.);
  ...
  TH1D* h_ppi0_bkg = new TH1D("h_ppi0_bkg","h_ppi0_bkg",60,0.,3.);
  TH1D* h_ppi1_bkg = new TH1D("h_ppi1_bkg","h_ppi1_bkg",60,0.,3.);
  TH1D* h_ppi2_bkg = new TH1D("h_ppi2_bkg","h_ppi2_bkg",60,0.,3.);
  TH1D* h_hel_bkg  = new TH1D("h_hel_bkg","h_hel_bkg",60,0.,1.);
  TH1D* h_helpi0_bkg  = new TH1D("h_helpi0_bkg","h_helpi0_bkg",60,0.,1.);

  TH1D* h_ptpi1_bkg = new TH1D("h_ptpi1_bkg","h_ptpi1_bkg",60,0.,3.);
  TH1D* h_ptpi2_bkg = new TH1D("h_ptpi2_bkg","h_ptpi2_bkg",60,0.,3.);
  ...
  sig_tree->SetBranchAddress("cos_hel",&cos_hel);
  ...
  bkg_tree->SetBranchAddress("cos_hel",&cos_hel);
...
//    if(bdt<0.18) continue;
  ...
  h_ppi0_sig->SetTitle("#pi^{0} momentum (sig D^{0}#omega)");
  ...
  h_ppi0_sig->Draw();
  c_ppi0_sig->Print("pics/ppi0_sig_omega.eps");
  ...
  h_ppi0_bkg->SetTitle("#pi^{0} momentum (bkg D^{0}#omega)");
  ...
  h_ppi0_bkg->Draw();
  c_ppi0_bkg->Print("pics/ppi0_bkg_omega.eps");
  ...
  h_ptpi2_bkg->SetTitle("p_{t} for #pi^{-} from #omega decay (bkg D^{0}#omega)");
  h_ptpi2_bkg->GetXaxis()->SetTitle("p_{t} (GeV)");
  h_ptpi2_bkg->GetXaxis()->SetTitleSize(0.06);
  h_ptpi2_bkg->GetXaxis()->SetTitleOffset(0.75);
  h_ptpi2_bkg->Draw();
  c_ptpi2_bkg->Print("pics/ptpi2_bkg_omega.eps");

  TCanvas* c_hel_sig = new TCanvas("c_hel_sig","c_hel_sig",600,400);
  c_hel_sig->cd();
  c_hel_sig->SetGrid();
  h_hel_sig->SetStats(0);
  h_hel_sig->GetYaxis()->SetLabelSize(0.06);
  h_hel_sig->GetXaxis()->SetLabelSize(0.06);
  h_hel_sig->SetLineWidth(2);
  h_hel_sig->SetTitle("|cos(#theta_{helicity})| for #omega (sig D^{0}#omega)");
  h_hel_sig->GetXaxis()->SetTitle("|cos(#theta_{helicity})|");
  h_hel_sig->GetXaxis()->SetTitleSize(0.06);
  h_hel_sig->GetXaxis()->SetTitleOffset(0.75);
  h_hel_sig->Draw();
  c_hel_sig->Print("pics/hel_sig_omega.eps");

  TCanvas* c_hel_bkg = new TCanvas("c_hel_bkg","c_hel_bkg",600,400);
  c_hel_bkg->cd();
  c_hel_bkg->SetGrid();
  h_hel_bkg->SetStats(0);
  h_hel_bkg->GetYaxis()->SetLabelSize(0.06);
  h_hel_bkg->GetXaxis()->SetLabelSize(0.06);
  h_hel_bkg->SetLineWidth(2);
  h_hel_bkg->SetTitle("cos(#theta_{helicity}) for #omega (bkg D^{0}#omega)");
  h_hel_bkg->GetXaxis()->SetTitle("cos(#theta_{helicity})");
  h_hel_bkg->GetXaxis()->SetTitleSize(0.06);
  h_hel_bkg->GetXaxis()->SetTitleOffset(0.75);
  h_hel_bkg->Draw();
  c_hel_bkg->Print("pics/hel_bkg_omega.eps");
  ...
  h_helpi0_sig->SetTitle("(E_{#gamma}^{H}-E_{#gamma}^{L})/(E_{#gamma}^{H}+E_{#gamma}^{L}) for #pi^{0} from #omega (sig D^{0}#omega)");
  ...
  h_helpi0_sig->Draw();
  c_helpi0_sig->Print("pics/helpi0_sig_omega.eps");
  ...
  h_helpi0_bkg->SetTitle("(E_{#gamma}^{H}-E_{#gamma}^{L})/(E_{#gamma}^{H}+E_{#gamma}^{L}) for #pi^{0} from #omega (bkg D^{0}#omega)");
  ...
  h_helpi0_bkg->Draw();
  c_helpi0_bkg->Print("pics/helpi0_bkg_omega.eps");
  }
  ...
  h_th_gh_sig->SetTitle("cos(#theta) of high energy #gamma from #pi^{0} (sig D^{0}#omega)");
  h_th_gh_sig->GetXaxis()->SetTitle("cos(#theta)");
  h_th_gh_sig->GetXaxis()->SetTitleSize(0.06);
  h_th_gh_sig->GetXaxis()->SetTitleOffset(0.75);
  h_th_gh_sig->Draw();
  c_th_gh_sig->Print("pics/th_gh_sig_omega.eps");
  }
  ...
  h_e_gl_bar_sig->SetTitle("Lower E_{#gamma} from #pi^{0} for barrel (sig D^{0}#omega)");
  ...
  h_e_gl_bar_sig->Draw();
  c_e_gl_bar_sig->Print("pics/e_gl_bar_sig_omega.eps");
  }
  ...
  h_e_gl_end_sig->SetTitle("Lower E_{#gamma} from #pi^{0} for endcap (sig D^{0}#omega)");
  ...
  h_e_gl_end_sig->Draw();
  c_e_gl_end_sig->Print("pics/e_gl_end_sig_omega.eps");
  }
  ...
  h_e_gh_bar_sig->SetTitle("Higher E_{#gamma} from #pi^{0} for barrel (sig D^{0}#omega)");
  ...
  h_e_gh_bar_sig->Draw();
  c_e_gh_bar_sig->Print("pics/e_gh_bar_sig_omega.eps");
  }
  ...
  h_e_gh_end_sig->SetTitle("Higher E_{#gamma} from #pi^{0} for endcap (sig D^{0}#omega)");
  ...
  h_e_gh_end_sig->Draw();
  c_e_gh_end_sig->Print("pics/e_gh_end_sig_omega.eps");
  }
  }
  ...
  h_th_gh_bkg->SetTitle("cos(#theta) of high energy #gamma from #pi^{0} (bkg D^{0}#omega)");
  h_th_gh_bkg->GetXaxis()->SetTitle("cos(#theta)");
  h_th_gh_bkg->GetXaxis()->SetTitleSize(0.06);
  h_th_gh_bkg->GetXaxis()->SetTitleOffset(0.75);
  h_th_gh_bkg->Draw();
  c_th_gh_bkg->Print("pics/th_gh_bkg_omega.eps");
  }
  ...
  h_e_gl_bar_bkg->SetTitle("Lower E_{#gamma} from #pi^{0} for barrel (bkg D^{0}#omega)");
  ...
  h_e_gl_bar_bkg->Draw();
  c_e_gl_bar_bkg->Print("pics/e_gl_bar_bkg_omega.eps");
  }
  ...
  h_e_gl_end_bkg->SetTitle("Lower E_{#gamma} from #pi^{0} for endcap (bkg D^{0}#omega)");
  ...
  h_e_gl_end_bkg->Draw();
  c_e_gl_end_bkg->Print("pics/e_gl_end_bkg_omega.eps");
  }
  ...
  h_e_gh_bar_bkg->SetTitle("Higher E_{#gamma} from #pi^{0} for barrel (bkg D^{0}#omega)");
  ...
  h_e_gh_bar_bkg->Draw();
  c_e_gh_bar_bkg->Print("pics/e_gh_bar_bkg_omega.eps");
  }
  ...
  h_e_gh_end_bkg->SetTitle("Higher E_{#gamma} from #pi^{0} for endcap (bkg D^{0}#omega)");
  ...
  h_e_gh_end_bkg->Draw();
  c_e_gh_end_bkg->Print("pics/e_gh_end_bkg_omega.eps");
  }
  }
